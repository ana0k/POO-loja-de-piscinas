...
public class Estoque {
	...
	int qt1 = 40;
		...
		void estoquetotal(){
			System.out.println("Estes são os produtos disponiveis no estoque da loja:\n");
			...
			System.out.println("\nEstes são os revestimentos disponiveis no estoque loja:\n");
			...
			switch (opcao) {
			case 2: System.out.println("\n\nVoltar ao menu do Administrador? [1 = sim - 2 = nao]: ");
