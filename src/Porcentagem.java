...
public class Porcentagem {
	...
	double lucrofinal;
	void porcentvenda() {
		System.out.println("Para descobrir o lucro em determinada venda faça uma simulação de compra:");
		...
		System.out.println("\nTOTAL: "+valorfinal);
		lucrofinal = valorfinal*75/100;
		System.out.println("\nNessa venda seu lucro seria de R$"+lucrofinal);
		
		System.out.println("\n\nDeseja voltar ao menu do Administrador? [1 = sim - 2 = nao]: ");
